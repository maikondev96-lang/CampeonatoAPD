    ...
    <div className="animate-fade" style={{ maxWidth: '900px', margin: '0 auto', paddingBottom: '5rem' }}>
      ...
      <div style={{ marginBottom: '8rem' }}>
        ...
        {loading && allChampions.length === 0 ? (
          ...
          <div style={{ textAlign: 'center', color: 'var(--text-muted)', padding: '2rem' }}>Aguardando finalização do primeiro torneio.</div>
        )}
      </div>
      ...
      <div style={{ position: 'relative' }}>
        ...
        {timeline.map((item, idx) => {
          ...
          return (
            <div key={item.year} style={{ display: 'flex', justifyContent: idx % 2 === 0 ? 'flex-start' : 'flex-end', width: '100%', marginBottom: '4rem', position: 'relative' }}>
